...
public class AgendaContatos {
    ...
    public Set<Contato> PesquisarPorNome(String nome){
        ...
        for(Contato c : contatoSet){ //Percorre o contatos set para achar qual contato começa com o nome passado
    ...
    public Contato atualizarNumeroContato(String nome, int novoNumero){
        ...
        for(Contato c : contatoSet){
            if (c.getNome().equalsIgnoreCase(nome)){ //Se o nome do contato for igual
