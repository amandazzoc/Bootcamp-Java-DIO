...
public class ContaTeste {
    ...
    void validarQuantidadeDeChamadas(){
        ...
        Mockito.verify(conta, Mockito.times(3)).validaSaldo(ArgumentMatchers.anyInt()); //Verifica na conta se ele chamou 3 vezes o valida saldo com qualquer número inteiro
    }
}
