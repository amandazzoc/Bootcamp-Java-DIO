...
public class MyApp implements CommandLineRunner{ //Com a implementação do commandLineRunner ele já irá executar automaticamente no 'primeirospassosapplication'
